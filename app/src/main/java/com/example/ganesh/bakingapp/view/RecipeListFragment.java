...
public class RecipeListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View contentView = inflater.inflate(R.layout.fragment_recipe_list, container, false);
        RecyclerView recipeListView = (RecyclerView)contentView.findViewById(R.id.recipe_list);
        final RecipeListAdapter adapter = new RecipeListAdapter((RecipieListActivity)getActivity());
        adapter.setRecipeClickListener((RecipieListActivity)getActivity());
        recipeListView.setAdapter(adapter);
        RecyclerView.LayoutManager layoutManager;
        if(contentView.getTag().equals("recipe_list_portrait")){
